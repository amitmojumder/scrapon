          ...
          <div class="row">
            ...
            <div class="span-content">
              ...
              <div class="dash-subheader clearfix"> <!--dash sub header start here-->
                <span class="suv-pur">Purchase</span>
              ...
              <hr> 
              <ul class="purchase-list"><!--purchase list start here-->
                <li class="clearfix">
                  <div class="purchase-img">
                    <a href="#"><img src="image/purchase-img.jpg" class="img-border2" alt="purchase image" /> <span class="new-tag"></span></a>
                  </div>
                  <div class="purchase-detail">
                    <p><a href="#">Vintage Papers and Photo Decorations V.1</a></p>
                    <span class="p-subheader">from  <a href="#">AwesomeAusi</a> in <a href="#">Complete Kits</a> » <a href="#">Vintage</a><br>
					$7.00 on Jan 21, 2013</span>
                  </div>
                  <div class="purchase-del">
                    <span class="download active"><a href="#">Download</a></span>
                  </div>
                </li>
                <li class="clearfix">
                  <div class="purchase-img">
