          ...
          <div class="row">
            ...
            <div class="span-content">
              ...
              <div class="dash-subheader clearfix"> <!--dash sub header start here-->
                <span class="suv-mail">Message<span class="ash">(2)</span></span>
              ...
              <ul class="message-list">
                <li class="clearfix">
                  <div class="comment-img">
                    <img src="image/commentimage/image4.jpg" class="img-border2" alt="image"/>
                  </div>
                  <div class="shop-member">
                    <p><span class="blakish">ShopDanboard</span><span class="comment-member">member</span></p>
                    <p>january12, 2013</p>
                  </div>
                  <div class="messege-detail">
                    <p class="blakish">This Is The Title <span class="pink">new</span></p>
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat - limited to 2 lines of characters before...</p>
                  ...
                  <div class="cross">
                    <a href="#"><img src="image/cross.png" alt="cross" /></a>
                  </div>
                </li>
                <li class="clearfix">
                  <div class="comment-img">
                    <img src="image/commentimage/image3.jpg" class="img-border2" alt="image"/>
                  </div>
                  <div class="shop-member">
                    <p><span class="blakish">ShopDanboard</span><span class="comment-member">member</span></p>
                    <p>january12, 2013</p>
...
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat - limited to 2 lines of characters before...</p>
                ...
                <li class="clearfix">
                  <div class="comment-img">
                    <img src="image/commentimage/image5.jpg" class="img-border2" alt="image"/>
                  </div>
                  <div class="shop-member">
                    <p><span class="blakish">ShopDanboard</span><span class="comment-member">member</span></p>
                    <p>january12, 2013</p>
