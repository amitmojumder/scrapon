            ...
            <div class="span-content">
               ...
               <div class="clearfix dashboard-phase">
                  <div class="dash-subheader clearfix"> <!--dash sub header start here-->
                    <span class="suv-sales">Sales</span> 
                  ...
                  <hr>                   
                  <table class="shopsales-table" width="100%">
                      <tr>
                        <th>Date</td>
                        <th>Description</td>
                        <th>Buyer</td>
                      ...
                      <tr>
                        ...
                        <td class="pink">SarahBScrappin</td>
                        <td>$5.00</td>
                        <td>$3.50</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Jan 01, 2013</td>
                        <td class="pink">Baby Boy Birthday Announcement</td>
                        <td class="pink">Crazy4Kittens</td>
                        <td>$5.00</td>
                        <td>$3.50</td>
                      </tr>
                      <tr>
