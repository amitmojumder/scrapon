          ...
          <div class="row">
            ...
            <div class="span-content">
              ...
              <div class="dash-subheader clearfix"> <!--dash sub header start here-->
                <span class="suv-scrap">My Scrapboxes <span class="blakish"> &raquo; Vintage Papers and Photo Corners</span></span>
              ...
              <ul class="product-list clearfix">
                	<li>
                      <div class="product-img">
                        ...
                        <div class="trans-bg">
                          <span class="transtable">
                            <a href="#" class="trans-search">view</a>
                            <a href="#" class="trans-cross">delete</a>
                          </span>
                        </div>
                      </div>
