          ...
          <div class="row">
            ...
            <div class="span-content">
              ...
              <div class="dash-subheader clearfix"> <!--dash sub header start here-->
                <span class="suv-scrap"><span class="blakish">My Scrapboxes</span> </span>
              </div> <!--dash sub header end here-->
              <hr> 
              <ul class="message-list">
                <li class="clearfix">
                  <div class="scrap-img">
                    <img src="image/scrapboxes.jpg" class="img-border2" alt="image"/>
                  </div>
                  <div class="scrap-detail">
                    <p class="blakish">Vintage Papers and Photo Decorations V.1</p>
<p>21 Products</p>
                  </div>
                  <div class="cross cross-scrap">
                    <a href="#"><img src="image/cross2.png" alt="cross" />delete</a>
                    <a href="#"><img src="image/pencil.png" alt="pecil" /> view/edit</a>
                  </div>
                </li>
                <li class="clearfix">
                  <div class="scrap-img">
